...
$numero = $_GET['num'];
$sentencia = "SELECT * FROM `segunda_especialidad` WHERE`Seg_Esp_Cod`='".$numero."'";
$resultado = mysqli_query($conexion, $sentencia) or die (mysql_error());
$filas=mysqli_fetch_assoc($resultado);
$contenido = [$filas['Seg_Esp_Cod'],$filas['Seg_Esp_Nom'],$filas['Seg_Est'],$filas['Escuela_Esc_Cod']];
        ...
        <div class="card text-center">
          <div class="card-header">
            <ul class="nav nav-pills card-header-pills">
              <li class="nav-item">
                <a class="btn btn-danger" href="../views/segunda_especialidad_ver.php">Ver Segundas Especialidades</a>
              </li>
            </ul>
            </div>
              <div class="card-body">
                <h5 class="card-title">Modificar</h5>
                <h6 class="card-subtitle mb-2 text-muted">Llene el formulario Modificar Segunda Especialidad</h6>
								<form name="actualizar" action="Actualizar_Segunda_Especialidad.php" method="post">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
									<input type="text" name="denominacion" class="form-control" id="segEspNombre" placeholder="Nombre de Segunda Especialidad" value="<?php echo $contenido[1] ?>">
                  </div>
                </div>
