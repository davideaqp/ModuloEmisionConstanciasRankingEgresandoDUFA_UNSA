        ...
        <div class="card text-center">
          <div class="card-header">
            <ul class="nav nav-pills card-header-pills">
              <li class="nav-item">
                <a class="btn btn-danger" href="especialidad_ver.php">Ver Especialidades</a>
              </li>
            </ul>
            </div>
              <div class="card-body">
                <h5 class="card-title">Agregar nueva Especialidad</h5>
                <h6 class="card-subtitle mb-2 text-muted">Llene el formulario para agregar nueva Especialidad</h6>
                <form action="./RES025Anadir.php">
                <div class="form-group row">
                  <label for="facultadNombre" class="col-sm-2 col-form-label">Nombre de Especialidad:</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="facultadNombre" placeholder="Nombre de Especialidad">
                  </div>
                </div>
                <div class="form-group row">
                <label for="facultadCodigo" class="col-sm-2 col-form-label">Codigo de Especialidad:</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="facultadCodigo" placeholder="Codigo de Especialidad">
              </div>
            </div>
