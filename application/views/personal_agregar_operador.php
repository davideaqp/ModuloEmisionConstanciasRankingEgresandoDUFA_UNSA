          ...
          <center>
            <div class="card text-center">
              <div class="card-body">
                ...
                <h6 class="card-subtitle mb-2 text-muted">Llene el formulario para agregar un nuevo Operador</h6>
                <form method="post" action="../controllers/RES-012_AgregarOperador.php">
                  <div class="form-group row">
                    <label for="operadorNombre" class="col-sm-2 col-form-label">Nombre:</label>
                    <div class="col-sm-10">
