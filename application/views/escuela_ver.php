...
<div class="container">
		<div class="row">
				<div class="col">
						<center><h3 class="text-uppercase">Escuelas</h3></center>
...
while($mostrar=mysqli_fetch_array($resultado)){
	if($mostrar['Esc_Est']==0)
		continue;
?>
												<tr>
												<td><?php echo $mostrar['Esc_Cod']?></td>
												<td><?php echo $mostrar['Esc_Nom']?></td>
												<td><?php echo $mostrar['Esc_Acr']?></td>
												<td><?php echo $mostrar['Esc_Est']?></td>
												<td><?php echo $mostrar['Facultad_Fac_Cod']?></td>
												<td>
																<?php $guia = $mostrar['Esc_Cod']?>
 																		<!--<input type="hidden" name="method" value="delete">-->
																		<!--<input type="hidden" name="product_id" value="">-->
																		<button type="button">

																		<a href="../controllers/RES022_ModificarEscuela.php?num=<?php echo $mostrar['Esc_Cod']?>"><i class="fa fa-trash" aria-hidden="true">Modificar</i>

																		</button>
																		<button onclick="deshabilitar(<?php echo $mostrar['Fac_Cod']?>)">
