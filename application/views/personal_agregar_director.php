        ...
        <div class="container">
          <center>
            ...
            <ul class="nav nav-pills card-header-pills">
              ...
              <div class="card-body">
                <h5 class="card-title">Agregar nuevo Director</h5>
                <h6 class="card-subtitle mb-2 text-muted">Llene el formulario para agregar un nuevo Director</h6>
                <form method="post" action="../controllers/RES-008_AgregarDirector.php">
                    <div class="form-group row">
                    <label for="facultadNombre" class="col-sm-2 col-form-label">Nombre:</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Ingrese nombre">
                    </div>
                  </div>
                    <div class="form-group row">
                      <label for="facultadCodigo" class="col-sm-2 col-form-label">Estado:</label>
                      <div class="col-sm-10">
