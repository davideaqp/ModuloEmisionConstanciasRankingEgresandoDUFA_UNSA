...
$sentenciaEscuelas = "SELECT Fac_Cod,Fac_Nom FROM `facultad`" ;
        ...
        <div class="card text-center">
          <div class="card-header">
            <ul class="nav nav-pills card-header-pills">
              <li class="nav-item">
                <a class="btn btn-danger" href="escuela_ver.php">Ver Escuelas</a>
              </li>
            </ul>
            </div>
              <div class="card-body">
                <h5 class="card-title">Agregar nueva Escuela</h5>
                <h6 class="card-subtitle mb-2 text-muted">Llene el formulario para agregar nueva Facultad</h6>
                <form name="CrearFacultad" action="../controllers/RES021_CrearEscuela.php" method="post">
                ...
                <div class="col-sm-10">
                  <input type="text" name="acrEsc" class="form-control" id="facultadCodigo" placeholder="Acronimo de Escuela">
              </div>
            </div>
            <div class="form-group row">
               ...
               <select name="facultad"  class="form-control">
                 <?php
                   ...
                   <option value="<?php echo $mostrar["Fac_Cod"]; ?>"><?php echo $mostrar["Fac_Nom"]; ?></option>
                   <?php }?>
                   </select>
