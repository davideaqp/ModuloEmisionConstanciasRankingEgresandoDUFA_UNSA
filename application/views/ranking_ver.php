...
<div class="container">
    <div class="row">
        <div class="col">
            <center><h3 class="text-uppercase">Rankings</h3></center>
...
<center>
    <button type="submit" class="btn btn-danger"onclick="window.location.href='ranking_emision_pregrado.php'">Atras</button>
</center>
