...
<div class="container">
    <div class="row">
        <div class="col">
            <center><h3 class="text-uppercase">Especialidades</h3></center>
...
<center>
    <button type="submit" class="btn btn-danger"onclick="window.location.href='especialidad_agregar.php'">Atras</button>
</center>
