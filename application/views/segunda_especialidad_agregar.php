...
$sentenciaEscuelas = "SELECT Esc_Cod,Esc_Nom FROM `escuela`" ;
...
<head>
  ...
  <script language="JavaScript">
    ...
    if (confirm('¿Estas seguro de enviar este formulario?')){
      document.CrearSegundaEspecialidad.submit()
    }
  }
  </script>
</head>
        ...
        <div class="card text-center">
          <div class="card-header">
            <ul class="nav nav-pills card-header-pills">
              <li class="nav-item">
                <a class="btn btn-danger" href="segunda_especialidad_ver.php">Ver Segundas Especialidades</a>
              </li>
            </ul>
            </div>
              <div class="card-body">
                <h5 class="card-title">Agregar nueva Segunda Especialidad</h5>
                <h6 class="card-subtitle mb-2 text-muted">Llene el formulario para agregar nueva Segunda Especialidad</h6>
                <form name="CrearSegundaEspecialidad" action="../controllers/CrearSegundaEspecialidad.php" method="post">
                <div class="form-group row">
                  <label for="segEspNombre" class="col-sm-2 col-form-label">Nombre  </label>
                  <div class="col-sm-10">
                    <input type="text" name="nombre" class="form-control" id="segundaEspecialidadNombre" placeholder="Nombre de la Segunda Especialidad">
                  </div>
                </div>
                <div class="form-group row">
                   <label for="escuelaCodigo" class="col-sm-2 col-form-label">Programa/Escuela:</label>
                   <div class="col-sm-7">
