        ...
        <div class="card text-center">
          <div class="card-header">
            <ul class="nav nav-pills card-header-pills">
              <li class="nav-item">
                <a class="btn btn-danger" href="grado_ver.php">Ver Grados</a>
              </li>
            </ul>
            </div>
              <div class="card-body">
                <h5 class="card-title">Agregar nuevo Grado</h5>
                <h6 class="card-subtitle mb-2 text-muted">Llene el formulario para agregar nuevo Grado</h6>
                <form name="CrearGrado" action="../controllers/CrearGrado.php" method="post">
                <div class="form-group row">
                  <label for="NombreGrado" class="col-sm-2 col-form-label">Grado:</label>
                  <div class="col-sm-10">
                    <input name="nombre" type="text" class="form-control" id="facultadNombre" placeholder="Grado">
                  </div>
                </div>
                <div class="form-group row">
