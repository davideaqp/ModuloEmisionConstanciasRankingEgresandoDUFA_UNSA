...
<div class="container">
		<div class="row">
				<div class="col">
						<center><h3 class="text-uppercase">Grados</h3></center>
...
$consulta = "SELECT Gra_Cod,Gra_Nom,Gra_Est,Esc_Nom FROM grado,escuela WHERE grado.Escuela_Esc_Cod = escuela.Esc_Cod ORDER BY Gra_Cod ASC";
$resultado = mysqli_query( $conexion, $consulta ) or die ( "Algo ha ido mal en la consulta a la base de datos");
//$mostrar=mysqli_fetch_array($resultado);
while($mostrar=mysqli_fetch_array($resultado)){
	if($mostrar['Gra_Est']==0)
		continue;
?>
												<tr>
												<td><?php echo $mostrar['Gra_Cod']?></td>
												<td><?php echo $mostrar['Gra_Nom']?></td>

                        <?php
                          $var = "Habilitado";
                          if($mostrar['Gra_Est']==2)
                              $var = "Desistido";
                        ?>
                        <td><?php echo $var?></td>
												<td><?php echo $mostrar['Esc_Nom']?></td>
												<td>
																<?php $guia = $mostrar['Gra_Cod']?>
																		<button type="button">

																		<a href="../controllers/Modificar_Grado.php?num=<?php echo $mostrar['Gra_Cod']?>"><i class="fa fa-trash" aria-hidden="true">Modificar</i>

																		</button>
																		<button onclick="deshabilitar(<?php echo $mostrar['Gra_Cod']?>)">
...
<center>
		<button type="submit" class="btn btn-danger"onclick="window.location.href='grado_agregar.php'">Atras</button>
</center>
